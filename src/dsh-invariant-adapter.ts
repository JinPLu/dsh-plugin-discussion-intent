/**
 * DSH invariant adapter: the named boundary for the invariant-checker entry.
 * `invariant.ts` stays a thin facade over this module; the sidecar logic it
 * exercises lives in the DSH-independent `sidecar.ts`.
 */
